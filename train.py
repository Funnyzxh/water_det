...
def main(opt, callbacks=Callbacks()):
    ...
    if not torch.cuda.is_available():
        print('\n\nyou are using cpu, it\'s gonna take a lot of time! check your settings')
        exit()
    if RANK in [-1, 0]:
...
# --data water_data.yaml --cfg yolov5m.yaml --weights pretrained/yolov5m.pt --epoch 100 --batch-size 2 --workers 2
